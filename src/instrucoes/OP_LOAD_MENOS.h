...
void op_load_menos_executar(int iteracao, BancoRegistradores *banco, ULA *ula);
void op_load_menos_escrita_resultados(BancoRegistradores *banco, Barramento *barramento, Memoria *memoria, ULA *ula);
